document.addEventListener(
  ...
  (() => {
    ...
    // map
    ymaps.ready(init);
    var map, myPlacemark1, myPlacemark2;
    ...
    function init() {
      ...
      (MyIconContentLayout = ymaps.templateLayoutFactory.createClass()),
        (myPlacemark1 = new ymaps.Placemark(
          [55.858822, 37.4243],
          {
            balloonContentHeader:
              '<img src="assets/img/footer/iconSova.png" alt="Sticky Nav Bar Logo" class="mapLogo"><span class="mapTitle">&nbspSova-dance</span>',
        ...
        //   {
        //     balloonContentHeader:
        //       '<img src="assets/img/footer/iconBus.png" alt="Sticky Nav Bar Logo" class="mapLogo"><span class="mapTitle">Трамвай №6</span>',
